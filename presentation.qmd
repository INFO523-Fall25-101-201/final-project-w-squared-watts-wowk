...
# Prophet model
df_prophet = df[['Date', 'log_CO']].rename(
    columns={'Date': 'ds', 'log_CO': 'y'})
...
* To truly evaluate urban activity affect on CO levels, we would need to broaden the scope by integrating additional datasets, such as weather variables (temperature, wind speed, precipitation) and demographic or traffic flow data. However, our research led us to the discovery that these data are not available publically for Massachusetts.
