...
This project investigates how urban activity patterns influence air quality in major Massachusetts cities, with a particular focus on CO concentrations. The dataset, drawn from the EPA, contains daily maximum 8 hour CO values spanning 2016 to 2024. Data from 2020 was intentionally excluded due to the impact of COVID 19 shutdowns, which significantly reduced travel and could have skewed the findings. To enrich the dataset, temporal indicators such as season, weekend status, and holiday occurrence were added, allowing for structured comparisons of pollution variability across different activity contexts. The goal of this research is to better understand how human activity cycles affect air quality and to provide insights that may inform urban planning and public health strategies.
...
As CO monitoring sites were only in urban centers in Massachusetts, the dataset was already refined to address the research question. The variables for season, weekend status (is_weekend), federal holidays (is_holiday), and long weekends (is_long_weekend) were added by analyzing the 'Date' column. 

Exploratory data analysis revealed measurable fluctuations in CO levels between weekdays and weekends, with extended weekends (those that include holidays) showing amplified reductions in pollution. Seasonal variation was also evident, with higher CO levels observed during colder months, likely due to atmospheric conditions that trap pollutants. Preprocessing steps included engineering categorical features and formatting the dataset to align with the requirements of time series modeling. For example, the dataset was structured with Prophet’s required column names, ds for the date and y for the target variable.
...
- [Presentation Recording](https://drive.google.com/file/d/1Je12-rug37mvMl8pIzi21opupNzBf6wM/view?usp=drive_link)
- [W-Squared GitHub Repository](https://github.com/INFO523-Fall25-101-201/final-project-w-squared-watts-wowk/tree/main)
- [EPA Data](https://www.epa.gov/outdoor-air-quality-data/download-daily-data)
